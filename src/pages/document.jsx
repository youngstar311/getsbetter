    ...
    <div className="homepage">
      ...
      <section id="featured-service" className="featured-service">
        <div className="service-highlight">
            ...
            <li>Bank Notes: $200 Each /$350 3 Month History. Depending on what bank pricing can go up as some templates are NOT easy. </li>
            <li>Digital SS card: $250/ 12 hour or less delivery </li>
            <li>⁠Blank CPN: $400w Digital SS card and 2 stubs</li>
            <li>⁠Cpn number look up: $200</li>
