  ...
  return (
    <div className="homepage">
      ...
      <section className="riskplay-included">
        ...
        <div className="included-grid">
          ...
          <div className="included-card">
            ...
            <p>✔ what to do when they violate the law (because most of them)</p>
          </div>
        </div>
      </section>
      ...
      <section className="riskplay-teach">
        <button className="swing-btn"> Teach Me How To Shut Down Collectors ss  FOR A LIMITED TIME ONLY</button>
      </section>
      ...
      <h2>We've personally We've personally Helped Over 1k Students and Remove hundreds of Thousands In debt</h2>
      ...
      <section className="riskplay-row">
        ...
        <ul>
          <li>❌ Collectors calling your phone 5x a day — at work, at home, in front of your kids.</li>
          <li>❌ Balances growing from fees and interest YOU never agreed to.</li>
          <li>❌ Collections dragging your score down 100+ points for up to 7 years.</li>
          <li>❌ Getting denied for apartments, car loans, and credit cards.</li>
          <li>❌ Paying a debt you might not even legally owe — just to make the calls stop.</li>
          <li>❌ Living in fear every time your phone rings from an unknown number.</li>
        </ul>
        </div>
      ...
      <section className="riskplay-method">
        ...
        <div className="riskplay-row">
            <div className="method-old">
              <p></p>
              <h3>The Old Way:</h3>
              <img src="/old_way.webp" alt="Credit Fix" />
              <ul>
                <li>Waiting 7 years to get negative items off your credit profile</li>
                <li>Paying debt collectors you don’t actually owe</li>
                <li>Disputing tirelessly without any results</li>
              </ul>
            </div>
            <div className="method-new">
              <h3>The New Way:</h3>
              <img src="/new_way.webp" alt="Credit Fix" />
              <ul>
                <li>Force them to prove the debt or delete the account entirely</li>
                <li>Send one legally-backed letter that puts the collector on a 30-day clock</li>
                <li>Dispute items stay off for good (won’t come back)</li>
              </ul>
            </div>
          </div>
          {/* Teach Me CTA */}
      ...
      <section className="riskplay-learn">
        ...
        <p>When you get The Collection Playbook you will learn exactly how to shut down collectors, force deletions, and protect yourself using federal law.</p>
        <div className="riskplay-row">
            <div className="learn-stage">
              <img src="/old_way.webp" alt="Credit Fix" />
              <h3>SECRET METHOD #1</h3>
              <p>How to use debt validation to force collectors to prove every dollar — or delete the account</p>
              <p>How to spot FDCPA violations collectors make on almost every call</p>
            </div>
            <div className="learn-stage">
              <img src="/old_way.webp" alt="Credit Fix" />
              <h3>SECRET METHOD #2</h3>
              <p>How to use cease & desist letters to legally stop all collector contact</p>
              <p>How to respond when collectors threaten lawsuits (most are bluffing)</p>
            </div>
            <div className="learn-stage">
              <img src="/old_way.webp" alt="Credit Fix" />
      ...
      <section className="riskplay-case">
        ...
        <p>Take a look at our student's results! My Deletion Blueprint can be the thing that takes everything to the next level.</p>

        {/* Case Study Grid */}
        <div className="case-grid">
          <div className="case-card">
            <img src="/case1.webp" alt="Case Study 1" />
            
          </div>
          <div className="case-card">
            <img src="/case2.webp" alt="Case Study 2" />
            
          </div>
          <div className="case-card">
            <img src="/case3.webp" alt="Case Study 3" />
        ...
        <div className="case-cta">
          <button className="case-btn">I'M READY TO GET RESULTS
          </button>
        </div>
      </section>
      ...
      <section className="riskplay-row1">
        ...
        <div className="row-right1">
          <img src="/playbook.webp" alt="Credit Fix" />
            <h1><p>You get instant access to:</p></h1>
            <p>✅ <h2>The Collection Playbook</h2><h3>$300 Value</h3></p>
            <p>✅ <h2>Debt Validation Letter</h2><h3>$300 Value</h3></p>
            <p>✅ <h2>Debt Tracker</h2><h3>$300 Value</h3></p>
