    ...
    <div className="homepage">
      ...
      <section className="riskplay-teach">
        ...
        <div className="service-grid">
          ...
          <div className="service-card risk">
            ...
            <a href="/services/risk" className="service-link">Learn More →</a>
          </div>
          <div className="service-card performance">
            ...
            <a href="/services/performance" className="service-link">Learn More →</a>
          </div>
          <div className="service-card technology">
            <h3>Car & Apartment Packages</h3>
            <p>Full CPN House Car and Apartment Package </p>
            <a href="/services/technology" className="service-link">Learn More →</a>
          </div>
          <div className="service-card change">
            <h3>Grant Funding</h3>
            <a href="/services/changee" className="service-link">Learn More →</a>
          </div>

          <div className="service-card change">
            <h3>Get all Documents Done</h3>
            <p>Do you need docs?</p>
            <a href="/services/change" className="service-link">Learn More →</a>
          </div>
      ...
      <section id="documents" className="documents">
        ...
        <div className="document-grid">
            ...
            <a href="/docs/whitepapers" className="doc-link">Explore →</a>
        </div>
        <div className="document-card case">
            ...
            <a href="/docs/case-studies" className="doc-link">Explore →</a>
        </div>
        ...
        <div className="about-content">
            ...
            ConsultingPro is a trusted partner for organizations seeking transformation. We combine industry expertise, data‑driven insights, and tailored strategies to deliver measurable results. Our approach is collaborative, transparent, and focused on aligning operations with your vision.
            </p>
